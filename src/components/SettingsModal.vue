    ...
    <div class="bg-dark rounded-2xl w-[500px] max-h-[80vh] overflow-y-auto border border-gray-700">
      ...
      <div class="p-6 space-y-6">
        <div>
          ...
          <div class="space-y-3">
            <div>
              <label class="text-xs text-gray-500 block mb-1.5">Base URL</label>
              <input
            ...
            <div>
              ...
              <div class="relative">
                ...
                <button
                  ...
                  type="button"
                  class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-300 active:scale-95 transition-all text-xs px-1"
          ...
          <div class="space-y-3">
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                placeholder="留空使用默认 Prompt。用 {records} 占位今日记录"
                class="w-full bg-darker border border-gray-700 rounded-lg px-3 py-2 text-sm focus:border-primary focus:outline-none resize-y"
              />
            </div>
          </div>
      ...
      <div class="px-6 py-4 border-t border-gray-700 flex items-center justify-between gap-3">
        ...
        <div class="flex gap-3">
          ...
          <button
            @click="saveSettings"
            :disabled="isSaving"
            class="px-4 py-2 bg-primary rounded-lg text-sm font-medium hover:bg-blue-600 active:scale-95 disabled:opacity-50 disabled:active:scale-100 transition-all"
          >
            {{ isSaving ? '保存中…' : '保存' }}
          </button>
        </div>
