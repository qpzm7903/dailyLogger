...
> 最后更新: 2026-03-28
> 当前版本: v3.8.0（已完成）
> 下一版本: v3.9.0（多 Vault 支持）
> 当前 Milestone: v3.9.0 多 Vault 支持

---

## 当前 Milestone：v3.9.0 多 Vault 支持

**目标**: 继续 VAULT-001 实现，支持基于窗口标题的自动 Vault 选择功能。
...
| 版本 | 方向 | 说明 |
|------|------|------|
| v3.9.0 | MINOR | 多 Vault 自动选择：VAULT-001 Task 2-6 完成 |
| v4.0.0 | 保留 | 仅当后续确实涉及不兼容的数据模型或分析管线变更时再考虑启用 |

---

## v3.9.0 详情（VAULT-001 续）
