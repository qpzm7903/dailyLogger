...
> 最后更新: 2026-03-20
> 当前版本: v1.28.0 ✅ 已发布
> 下一版本: v1.29.0（TypeScript 基础设施）

---

## 下一迭代: v1.29.0（TypeScript 基础设施）🚧 待开发

**目标**: 为前端引入 TypeScript 基础设施，为后续全量代码迁移做准备。

**版本类型**: MINOR（技术基础设施升级）

**背景**: 项目当前前端代码（`src/`）全部为 JavaScript（`.js`），缺乏类型安全保障，随着功能复杂度增长，维护风险上升。本版本完成基础设施层面的 TS 接入，下一版本（v1.30.0）完成代码层面的全量迁移。
...
## 下下迭代: v1.30.0（前端代码全量迁移至 TypeScript）📋 规划中
