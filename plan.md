...
> 最后更新: 2026-03-16
> 当前版本: v1.10.0 ✅ 已发布（历史 Draft Release 已全部发布）
> 下一版本: v1.11.0
...
## 当前迭代: v1.11.0（功能扩展与 Bug 修复）

**目标**: 新增报告对比分析、多 Obsidian Vault 输出支持，修复月报路径覆盖 Bug。

| ID | 需求 | 故事点 | 状态 |
|----|------|--------|------|
| REPORT-004 | 报告对比分析 | 5pts | 待开发 |
| DATA-006 | 多 Obsidian Vault 支持 | 3pts | 待开发 |
| FIX-001 | 月报路径覆盖日报路径 Bug | 1pt | 待开发 |
...
| 月报生成覆盖日报路径（`last_summary_path`） | 生成月报后日报路径丢失 | v1.8.0+ | 🔧 v1.11.0 修复 (FIX-001) |
