...
|----|------|--------|--------|------|------|
| MAINT-015 | 检查并清理未使用的依赖/代码 | 1pt | LOW | ⏳ 待开始 | — |
| MAINT-016 | 完善国际化覆盖（补充缺失的翻译） | 2pts | LOW | ⏳ 待开始 | — |
| MAINT-017 | 添加更多的前端组件测试 | 2pts | MEDIUM | ⏳ 待开始 | — |

**备注**:
- 此版本为维护性版本，主要关注代码质量和测试覆盖率
- 如有新的用户需求或 Issues，将调整版本目标
